...
import {clearLikeNotifications,clearFollowNotifications,} from "@/redux/rtnSlice";
              ...
              {item.text === "Notifications" && (
                <>
                  {likeNotification?.length > 0 && (
                    <Popover
                      onOpenChange={(open) =>
                        !open && handleNotificationClick("like")
                      }
                    >
                  ...
                  {followNotification?.length > 0 && (
                    <Popover
                      onOpenChange={(open) =>
                        !open && handleNotificationClick("follow")
                      }
                    >
                      <PopoverTrigger asChild>
                        <Button
                      ...
                      <PopoverContent>
                        <div>
                          {followNotification.length === 0 ? (
                            <p>No new follow notifications</p>
                          ) : (
